...
const SignInForm = () => {
    return (
        <>
            <Grid container sx={{backgroundSize: 'cover', background: 'linear-gradient(rgba(48,94,171, 0.7), rgba(115, 35, 101, 0.7)), url(authentication.jpg)', height: "86.6vh"}} justifyContent={"center"}>
